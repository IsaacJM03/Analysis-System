...
class Tracker:
  ...
  #       bbox = frame_detection[0].tolist() #bbox stands for bounding box that comes with yolov5 detection
  ...
  def draw_ellipse(self,frame,bbox,color,track_id=None):
      ...
      x2_rect = x_center + rectangle_width//2 # doing all this to make the number appear in the venter
